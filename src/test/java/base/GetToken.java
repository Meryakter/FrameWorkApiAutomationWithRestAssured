...
public class GetToken {
    ...
    public static String getToken() {
        // Set the base URL
        RestAssured.baseURI = PayloadProcessor.getValueFromPropertiesFile().getProperty("tokenURL");
        ...
        String clientSecret = PayloadProcessor.getValueFromPropertiesFile().getProperty("secretID");
