...
public class Base {
    ...
    public static String getSessionId(){
        ...
        response = POSTRequest(endPointURI,loginPayload,getSessionId());
...
*/
    ...
    public static Response POSTRequest(String uRI, String strJSON, String queryKey, String queryValue) {
